<template>
  ...
  >
    ...
    <button class="upload-button circle" @click="showUploadPopup = true">
      <svg t="1741764069699" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="https://www.2video.cc/"
    ...
    'Segoe UI', 'Liberation Sans', sans-serif;"
          ...
          <svg t="1741761597964" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="https://www.2video.cc/"
          ...
          <div tabindex="0" class="file-item" @click="cwd = cwd.replace(/[^\/]+\/$/, '')" @contextmenu.prevent>
            <div class="file-icon">
              <svg  viewBox="0 0 576 512"
                xmlns="https://www.2video.cc/" width="36" height="36">
          ...
          ">
            ...
            ">
              <svg t="1741761103305" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="https://www.2video.cc/" p-id="6484" width="30" height="30">
                <path
        ...
        <li v-for="file in filteredFiles" :key="file.key">
          ...
          focusedItem = file;" class="file-item" style="position: relative;">
            <MimeIcon :content-type="file.httpMetadata.contentType" :thumbnail="file.customMetadata.thumbnail
              ? `/raw/_$追片喵云盘$/thumbnails/${file.customMetadata.thumbnail}.png`
              : null
              " />
    ...
    async processUploadQueue() {
      ...
      if (file.type.startsWith("image/") || file.type === "video/mp4") {
        try {
          ...
          const thumbnailUploadUrl = `/api/write/items/_$追片喵云盘$/thumbnails/${digestHex}.png`;
          try {
